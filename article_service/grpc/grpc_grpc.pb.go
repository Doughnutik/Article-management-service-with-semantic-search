...
const (
	SearchService_IndexArticle_FullMethodName   = "/grpc.SearchService/IndexArticle"
	SearchService_SemanticSearch_FullMethodName = "/grpc.SearchService/SemanticSearch"
)
...
type SearchServiceClient interface {
	IndexArticle(ctx context.Context, in *ArticleEmbeddingRequest, opts ...grpc.CallOption) (*ArticleEmbeddingResponse, error)
...
func (c *searchServiceClient) IndexArticle(ctx context.Context, in *ArticleEmbeddingRequest, opts ...grpc.CallOption) (*ArticleEmbeddingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ArticleEmbeddingResponse)
...
func (c *searchServiceClient) SemanticSearch(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type SearchServiceServer interface {
	IndexArticle(context.Context, *ArticleEmbeddingRequest) (*ArticleEmbeddingResponse, error)
...
func (UnimplementedSearchServiceServer) IndexArticle(context.Context, *ArticleEmbeddingRequest) (*ArticleEmbeddingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IndexArticle not implemented")
}
func (UnimplementedSearchServiceServer) SemanticSearch(context.Context, *SearchRequest) (*SearchResponse, error) {
...
func _SearchService_IndexArticle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ArticleEmbeddingRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServiceServer).IndexArticle(ctx, req.(*ArticleEmbeddingRequest))
	}
...
func _SearchService_SemanticSearch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServiceServer).SemanticSearch(ctx, req.(*SearchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
